frappe.ui.form.on("Physician", {
	...
	rnc_cedula: frm => {
		frm.set_value("rnc_cedula",mask_ced_pas_rnc(frm.doc.rnc_cedula))
	},
	mobile_phone: frm => {
		frm.set_value("mobile_phone",mask_phone(frm.doc.mobile_phone))
	},
	residence_phone: frm => {
		frm.set_value("residence_phone",mask_phone(frm.doc.residence_phone))
	},
	office_phone: frm => {
		frm.set_value("office_phone",mask_phone(frm.doc.office_phone))
	}
});
